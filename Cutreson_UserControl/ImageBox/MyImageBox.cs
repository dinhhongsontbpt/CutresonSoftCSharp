...
using Cutreson_UserControl.ImageBox;
using Cutreson_UserControl.MyUserControl.ImageBox;
using System;
...
namespace Cutreson_UserControl
{
  ...
  [ToolboxBitmap(typeof(MyImageBox), "ImageBox.bmp")]
  [ToolboxItem(true)]
  ...
  public class MyImageBox : VirtualScrollableControl
  {
    #region Constants
    ...
    /// <summary>
    ///   Initializes a new instance of the <see cref="MyImageBox" /> class.
    /// </summary>
    public MyImageBox()
    {
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the mouse wheel is processed event if the <see cref="MyImageBox"/> doesn't have focus.
    /// </summary>
    /// <value>
    ...
    protected virtual void DrawSelection(PaintEventArgs e)
    {
      ...
      //}
      using (Pen pen = new Pen(Color.FromArgb(128, this.SelectionColor), 3))
      {
