...
namespace _06_Terumo
{
	...
	namespace CdioCs
	{
		...
		public class Cdio
		{
			...
			[DllImport("cdio.dll")] static extern int DioGetNetCommunicationInfo(short Id, short InfoType, [MarshalAs(UnmanagedType.LPArray)] int[] InfoData);
			...
			public int GetNetCommunicationInfo(short Id, short InfoType, int[] InfoData)
			{
				int ret = DioGetNetCommunicationInfo(Id, InfoType, InfoData);
				return ret;
			}
